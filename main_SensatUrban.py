...
class SensatUrban:
    def __init__(self):
        ...
        root_path = '/home/jzp/workspace/code/SensatUrban-master/Dataset'  # path to the dataset
    ...
    def get_tf_mapping2():
        ...
        def tf_map(batch_xyz, batch_features, batch_labels, batch_pc_idx, batch_cloud_idx):
            ...
            row_features = tf.concat([batch_xyz, batch_features], axis=-1)
            input_points = []
            input_colors = []
            input_neighbors = []
            input_pools = []
            ...
            input_list += [row_features, batch_labels, batch_pc_idx, batch_cloud_idx]
